...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous">        <!-- CSRF Token -->
        ...
        　　<div class="row">
            ...
            <div class="row">
                <div id="header right">
                    ...
                    <a class="web">WEB予約<span class="reception">24時間受付</span><br>
